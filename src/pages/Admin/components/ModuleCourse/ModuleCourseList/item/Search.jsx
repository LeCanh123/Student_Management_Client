...
import { list ,pagination,setSeachStatus,setSeachValue} from '../../../../../../redux/slices/module-course-slice'; 
...
export default function Search() {
  ...
  async function handleSearch(e){
    ...
    const searchList = await apis.moduleCourseApi.search(access_token,keywordValue,0,take);
